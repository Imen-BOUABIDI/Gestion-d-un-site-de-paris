...
public class TestMetier {
	...
	public static void testConstructeurSiteDeParisMetier () {
		...
		catch (MetierException e) { System.out.println("pass null");}
		catch (Exception e) { 
		...
		catch (MetierException e) { System.out.println("longeur non suffisante");}
		catch (Exception e) { 
		...
		catch (MetierException e) {System.out.println("espace"); }
		catch (Exception e) { 
		...
		catch (MetierException e) {System.out.println("char -"); }
		catch (Exception e) { 
	...
	public static void testValiditePasswordGestionnaire () {
		...
		try {
			...
			catch (MetierException e) { System.out.println("lenght du pass nulle 2");}
			catch (Exception e) { 
			...
			catch (MetierException e) { System.out.println("lenght du pass <8  2");}
			catch (Exception e) { 
			...
			catch (MetierException e) {System.out.println("pass conteint espace 2"); }
			catch (Exception e) { 
			...
			catch (MetierException e) { System.out.println("pass conteint - 2");}
			catch (Exception e) { 
	...
	public static void testInscrireDesinscrireJoueur () {
		...
		try {
			...
			catch (JoueurException e) {System.out.println("prenom invalide (non instancié)"); }
			catch (Exception e) { 
			...
			catch (JoueurException e) {System.out.println("nom invalide (non instancié)"); }
			catch (Exception e) { 
			...
			catch (JoueurException e) { System.out.println("pseudo invalide (non instancié)");}
			catch (Exception e) { 
			...
			catch (MetierException e) { System.out.println("password gestionnaire (non instancié)");}
			catch (Exception e) { 
			...
			catch (JoueurException e) { System.out.println("prénom invalide");}
			catch (Exception e) { 
			...
			catch (JoueurException e) {System.out.println("nom invalide"); }
			catch (Exception e) { 
			...
			catch (JoueurException e) {System.out.println("pseudo invalide"); }
			catch (Exception e) { 
			...
			catch (MetierException e) { System.out.println("password gestionnaire invalide");}
			catch (Exception e) { 
			...
			catch (MetierException e) { System.out.println("password gestionnaire incorrecte");}
			catch (Exception e) { 
			...
			catch (JoueurExistantException e) { System.out.println("joueur existant1");}
			catch (Exception e) { 
			...
			catch (JoueurExistantException e) { System.out.println("joueur existant2");}
			catch (Exception e) { 
			...
			catch (JoueurExistantException e) { System.out.println("joueur existant3");}
			catch (Exception e) { 
			...
			catch (JoueurInexistantException e) {System.out.println("joueur inexistant1"); }
			catch (Exception e) { 
			...
			catch (MetierException e) {System.out.println("désinscrire un joueur avec un  password gestionnaire incorrect"); }
			catch (Exception e) { 
			...
			catch (JoueurInexistantException e) { System.out.println("joueur inexistant2");}
			catch (Exception e) { 
	...
	public static void testConsulterJoueurs () {
		...
		try {
			...
			catch (MetierException e) { System.out.println("password invalide (non instancié)");}	
			catch (Exception e) { 
			...
			catch (MetierException e) { System.out.println("password invalide (moins de 4 caractères)");}			
			catch (Exception e) { 
			...
			catch (MetierException e) { System.out.println("password incorrect");}			
			catch (Exception e) { 
